...
import { Baby, CloudRain, Droplet, Star } from "lucide-react";
...
const babyCareSliderIcons = [
    { label: "Gentle", icon: Baby },
    { label: "Hydrate", icon: Droplet },
    { label: "Calm", icon: CloudRain },
];
    ...
    return (
        <section className="w-full bg-white py-10">
            <div className="mx-auto w-full max-w-[1280px] px-4 lg:px-8">
                <SectionIntroMobile
                    title="Snuggle-Soft Baby Care"
                    description="Nourishing washes and creams crafted for delicate newborn skin."
                    icons={babyCareSliderIcons}
                />
